                            ...
                            <div class="items">
                                <ul>
                                    <#list imageList as item >
                                        <li><img src="${item.url}" bimg="${item.url}" onmouseover="preview(this)"></li>
                                    </#list>
                                </ul>
                            </div>
                            <a class="next">&gt;</a>
                            ...
                            <#list specificationList as s>
                                ...
                                <#list s.attributeValue as item>
                                     <dd><a href="javascript:;"
                                            ...
                                            @click="selectSpec('${s.attributeName}','${item}');">${item}<span
                                             title="点击取消选择">&nbsp;</span>
                                     </a></dd>
                                </#list>
                                 </dl>
                        ...
                        <div class="summary-wrap">
                            ...
                            <div class="fl">
                                <ul class="btn-choose unstyled">
                                    <li>
                                        <a href="javascript:;"
                                           class="sui-btn  btn-danger addshopcar" @click="addToCart()">加入购物车</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <ul class="goods-list unstyled">
                                ...
                                <li>
                                    <div class="list-wrap">
                                        ...
                                        <div class="operate">
                                            <a href="javascript:void(0);" class="sui-btn btn-bordered" @click="addToCart()">加入购物车</a>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div class="list-wrap">
                                        ...
                                        <div class="operate">
                                            <a href="javascript:;" class="sui-btn btn-bordered" @click="addToCart()">加入购物车</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="clearfix fitting">
                        ...
                        <div class="good-suits">
                            ...
                            <div class="fr result">
                                ...
                                <button class="sui-btn  btn-danger addshopcar" @click="addToCart();">加入购物车</button>
                            </div>
                        </div>
                    </div>
